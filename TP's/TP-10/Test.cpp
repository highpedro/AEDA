...
void test_a_CarregaObjetos() {
	...
	objetos.push_back(Objeto(1, 2));
	objetos.push_back(Objeto(2, 11));
	objetos.push_back(Objeto(3, 17));
	objetos.push_back(Objeto(4, 3));
	objetos.push_back(Objeto(5, 9));
	objetos.push_back(Objeto(6, 4));
	objetos.push_back(Objeto(7, 2));
	objetos.push_back(Objeto(8, 12));
	objetos.push_back(Objeto(9, 7));
	objetos.push_back(Objeto(10, 1));
...
void test_b_ProcuraCaixa() {
	vector<Objeto> objetos;
	objetos.push_back(Objeto(1, 2));
	objetos.push_back(Objeto(2, 5));
	objetos.push_back(Objeto(3, 8));
	objetos.push_back(Objeto(4, 1));
	objetos.push_back(Objeto(5, 4));
	objetos.push_back(Objeto(6, 6));
	objetos.push_back(Objeto(7, 1));
	objetos.push_back(Objeto(8, 4));
	...
	cout << "Carga livre em C" << c1.getID() << ": " << c1.getCargaLivre()
			<< endl; //3
	cout << "Carga livre em C" << c2.getID() << ": " << c2.getCargaLivre()
			<< endl; //2
	...
	maquina.addCaixa(cx);
	cout << "Carga livre em C" << cx.getID() << ": " << cx.getCargaLivre()
			<< endl;
...
void test_c_EmpacotaObjetos() {
	...
	objetos.push_back(Objeto(11, 10));
	objetos.push_back(Objeto(12, 1));
...
void test_f_CaixaMaisObjetos() {
	...
	ASSERT_THROWS(maquina.caixaMaisObjetos(),
			MaquinaEmpacotar::MaquinaSemCaixas);
	try {
		cx = maquina.caixaMaisObjetos();
	} catch (MaquinaEmpacotar::MaquinaSemCaixas &msc) {
		ASSERTM(
				"Este teste nunca falha! VERIFICAR informacao escrita no monitor",
				true);
	}
