...
public:
	...
	/* C */
	bool borrowBookFromCatalog(Book* book, User* reader);
	...
	// Part III - Piority Queue
	/* F */
	void addBestReaderCandidates(const vector<User>& candidates, int min);
	/* G */
	int awardReaderChampion(User& champion);
};
